...
export const LogoIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg width="48" height="48" viewBox="0 0 42 42" xmlns="http://www.w3.org/2000/svg" {...props}>
...
export const Logo = () => {
  return (
    <div className="flex items-center gap-1 relative z-10 text-left">
      <LogoIcon className="transition-colors duration-1000" />
      <span className="font-black text-sm uppercase w-20 leading-[14px] transition-colors  duration-1000">
        Evaa Protocol
      </span>
    </div>
  );
